...
typedef struct infojugador ijugador;

bool menuListaJugadores (vector<ijugador> &Jugadores){
        int select1; ijugador Player; int eliminacion=0; int cont_a=0; int cont_n=0; ;int terminar=0; int max_jugadores=0;
        ijugador Player2; float total_a; float total_n;
        vector <ijugador> Copia;
        float Ptotal;
        Jugadores.clear();
        while(terminar!=5){
            cout << "\n********** MENU **********" << endl;
                ...
                break;
                    case 4:
                        ...
                        case 5:
                            ...
                            cout<< "Total a pagar por adulto:"<< "\t$"<< total_a << endl;
